...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = await bot_instance.process_message(message, user_id)
...
async def handle_audio(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Maneja mensajes de audio transcribiéndolos y procesándolos como texto"""
    user_id = update.effective_user.id
...
def main():
    ...
    print("🤖 Gemini maneja TODO: parsing, estándares, búsqueda web, consultas")
    print("🎤 NUEVA: Transcripción de audio con IA")
    print("📚 Extrae estándares del PDF del MEN o busca en Internet")
    print("💡 NUEVO: Incluye proferick.com en recursos")
    print("🔄 Resetea conversación automáticamente en saludos/nuevos planes")
    ...
    print("✅ Bot CON AUDIO iniciado exitosamente en Render!")
    print("🔗 Link: https://t.me/planeadores_aula_rick_bot")
    print("🎤 Ahora acepta mensajes de texto Y audio")
